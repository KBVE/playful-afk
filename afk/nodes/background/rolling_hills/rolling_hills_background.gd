...
func _calculate_safe_rectangle() -> void:
	...
	# Expand horizontal bounds by 200px on each side (total 400px expansion)
	var safe_x_start = -200.0
	var safe_width = tile_width + 400.0  # Add 200px to each side (left and right)
